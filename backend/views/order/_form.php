...
<div class="order-form">
    ...
    <?= $form->field($model, 'order_checking')->textInput() ?>

    <?= $form->field($model, 'phone')->textInput() ?>

    <?= $form->field($model, 'sell_all')->textInput() ?>

    <?= $form->field($model, 'clearing_all')->textInput() ?>

    <?= $form->field($model, 'sell_all_checking')->textInput() ?>

    <?= $form->field($model, 'clearing_all_checking')->textInput() ?>
