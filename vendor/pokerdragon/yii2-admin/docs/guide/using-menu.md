...
```php
use pokerDragon\admin\components\MenuHelper;
...
Return of `pokerDragon\admin\components\MenuHelper::getAssignedMenu()` has default format like:
...
return format of `pokerDragon\admin\components\MenuHelper::getAssignedMenu()` by provide a callback to this method.
...
Using Sparated Menu
-------------------
Second parameter of `pokerDragon\admin\components\MenuHelper::getAssignedMenu()` used to get menu on it's own hierarchy.
...
```php
<?php
user pokerDragon\admin\components\Helper;
...
```php
use pokerDragon\admin\components\Helper;
