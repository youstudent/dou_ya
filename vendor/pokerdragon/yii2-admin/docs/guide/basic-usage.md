...
'modules' => [
    ...
    'admin' => [
        'class' => 'pokerDragon\admin\Module',
        'layout' => 'left-menu', // it can be '@path/to/your/layout'.
        'controllerMap' => [
            'assignment' => [
                'class' => 'pokerDragon\admin\controllers\AssignmentController',
...
The code below shows how to use ACF which is implemented as `pokerDragon\admin\components\AccessControl`:

```php
'as access' => [
    'class' => 'pokerDragon\admin\components\AccessControl',
    'allowActions' => [
        'site/login', 
        'site/error',
    ]
